...
const longestString = (arr) => {
  ...
  //   if (str.length > arr[longestStringIndex].length) {
  //     longestStringIndex = index;
  //   }
  // });
  // return arr[longestStringIndex].length ? longestStringIndex : -1;
};
...
// Clarissa worked on problem two with me.
...
const findHappiness = (arr) => arr.filter(index => index.includes(':)'));
// Solution code here...
...
const standardizePhoneNumbers = (arr) => {
  // Solution code here...
  return arr.map(numbers => `${numbers.substring(1, 4)}${numbers.substring(6, 9)}${numbers.substring(10, 14)}`);
};
...
//Worked with Chralie and Clarissa
/* ------------------------------------------------------------------------------------------------
CHALLENGE 6
...
const allHappy = (arr) => arr.every(value => value.includes(':)'));
// Solution code here...
