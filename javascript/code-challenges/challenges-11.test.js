...
const count = (target, input) => {
  ...
  return storageArr.length;
};
//Worked with Yrim on this problem.
/* ------------------------------------------------------------------------------------------------
CHALLENGE 3
...
let findShortest = (data) => {
  // Solution code here...
  return data.reduce((shortestAtThisPoint, additionalChar) => Number(shortestAtThisPoint.height) < Number(additionalChar.height) ? shortestAtThisPoint : additionalChar).name;
